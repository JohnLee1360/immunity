...
def args_parser():
    ...
    # 
    parser.add_argument('--parties', type=str, default='',
                    help="the id of attacker")
    ...
    parser.add_argument('--attacker_id', type=int, default=0,
                        help="the id of attacker")
    parser.add_argument('--model_save_dir', type=str, default='./fl_run/model/node',
                        help="the dir of saving the parameters of model")   
