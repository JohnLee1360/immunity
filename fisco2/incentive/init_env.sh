...
#mac aarch 64 版
SOLC_MAC_URL="https://github.com/FISCO-BCOS/solidity/releases/download/v0.4.25/solc-mac-aarch64.tar.gz"
...
# mac aarch 64 国密版
SOLC_MAC_GM_URL="https://github.com/FISCO-BCOS/solidity/releases/download/v0.4.25/solc-mac-aarch64-gm.tar.gz"
